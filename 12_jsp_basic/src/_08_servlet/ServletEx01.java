...
public class ServletEx01 extends HttpServlet {  // Http 통신이 가능한 HttpServlet클래스를 상속받아 구현한다.
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dis = request.getRequestDispatcher("chapter08_servlet/servletEx01.jsp"); // WebContent 하위 경로부터 기술한다.
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dis = request.getRequestDispatcher("chapter08_servlet/servletEx01Action.jsp");
		dis.forward(request, response);
